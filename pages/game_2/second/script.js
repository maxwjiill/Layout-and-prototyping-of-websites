let playerName = '';
    ...
    const levels = [
      ...
      },
      {
        ...
        answer: 'Собака',
        images: ['images/fox.jpeg', 'images/cat.png', 'images/dog.avif'],
        options: ['Лиса', 'Кошка', 'Собака']
      },
      {
        type: 'matching',
        name: 'Уровень 2',
    ...
    function generateLevel() {
      ...
      if (level.type === 'question') {
        ...
        <div class="goalie-obstacle" style="top: 50px; left: 100px;">
        <img src="images/tree.png" alt="Tree">
      </div>
      <div class="goalie-obstacle" style="top: 50px; left: 450px;">
        <img src="images/tree.png" alt="Tree">
      </div>
      <div class="goalie-obstacle" style="top: 50px; left: 300px;">
        <img src="images/tree.png" alt="Tree">
      </div>
      <div class="goalie-obstacle" style="top: 150px; left: 250px;">
        <img src="images/tree.png" alt="Tree">
      </div>
      <div class="goalie-obstacle" style="top: 150px; left: 350px;">
        <img src="images/tree.png" alt="Tree">
      </div>
      <div class="goalie-obstacle" style="top: 250px; left: 100px;">
        <img src="images/tree.png" alt="Tree">
      </div>
      <div class="goalie-obstacle" style="top: 250px; left: 300px;">
        <img src="images/tree.png" alt="Tree">
      </div>
      <div class="goalie-obstacle" style="top: 250px; left: 450px;">
        <img src="images/tree.png" alt="Tree">
      </div>
